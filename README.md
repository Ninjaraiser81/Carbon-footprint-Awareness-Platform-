...
|
 🔐 Auth 
|
 JWT-based register/login with bcrypt 
|
|
 📊 Dashboard 
|
 KPI cards, trend chart, category breakdown 
|
|
 📝 Activity Log 
|
 65+ emission factor subcategories 
|
|
 🧠 Insights 
|
 Personalized recommendations + eco score 
|
|
 🏆 Badges 
|
...
|
 📜 History 
|
 Full CRUD with filters + pagination 
|
|
 ♿ Accessibility 
|
 WCAG 2.1 AA — ARIA, keyboard nav, focus mgmt 
|
|
 🔒 Security 
|
 CORS, CSP, rate limiting, input validation 
|
|
 🧪 Tests 
|
 75+ tests, 95%+ coverage target 
|
---
## 🔒 Security Checklist
